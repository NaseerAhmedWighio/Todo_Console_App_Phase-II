...
def test_basic_functionality():
    ...
    if task and task.description == "Test task for verification" and task.status == "incomplete":
        print("   OK Task created successfully with correct properties")
    else:
    ...
    if len(tasks) == 1 and tasks[0].id == task.id:
        print("   OK Retrieved all tasks successfully")
    else:
        print("   FAIL Failed to retrieve all tasks")
        return False
    ...
    if retrieved_task and retrieved_task.id == task.id:
        print("   OK Retrieved specific task successfully")
    else:
        print("   FAIL Failed to retrieve specific task")
        return False
    ...
    if completed_task and completed_task.status == "complete":
        print("   OK Task marked as complete successfully")
    else:
    ...
    if incomplete_task and incomplete_task.status == "incomplete":
        print("   OK Task marked as incomplete successfully")
    else:
    ...
    if success:
        ...
        if len(tasks_after_delete) == 0:
            ...
            print("   FAIL Task deletion failed - task still exists")
            return False
    else:
...
def test_edge_cases():
    ...
    if retrieved_task is None:
        print("   OK Correctly handled non-existent task")
    else:
        print("   FAIL Did not handle non-existent task properly")
        return False
    ...
    if updated_task is None:
        print("   OK Correctly handled update of non-existent task")
    else:
        print("   FAIL Did not handle update of non-existent task properly")
        return False
    ...
    if not success:
        print("   OK Correctly handled deletion of non-existent task")
    else:
        print("   FAIL Did not handle deletion of non-existent task properly")
        return False
    ...
    if completed_task is None:
        print("   OK Correctly handled marking complete of non-existent task")
    else:
        print("   FAIL Did not handle marking complete of non-existent task properly")
        return False
    ...
    if incomplete_task is None:
        print("   OK Correctly handled marking incomplete of non-existent task")
    else:
        print("   FAIL Did not handle marking incomplete of non-existent task properly")
        return False
...
def test_validation():
    ...
    try:
        ...
        try:
            ...
            print("   FAIL Did not catch empty description validation")
            return False
        except ValidationError:
            print("   OK Correctly caught empty description validation")
    except ImportError:
        print("   SKIP Skipping validation test - pydantic not available in this context")
